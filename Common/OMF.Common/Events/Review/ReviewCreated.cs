...
namespace OMF.Common.Events.Review
{
    public class ReviewCreated : IEvent
    {
        ...
        public ReviewCreated(string textReview, decimal rating, string resturentname, int resturentid, string userName, DateTime updatedOn, Guid orderId, Guid reviewId)
        {
